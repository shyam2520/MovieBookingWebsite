...
if(!isset($_SESSION['user']))
{
	...
	$_SESSION['mname']=$movie['movie_name'];
							...
							<?php
								...
								$shw=mysqli_fetch_array($s);
									...
									<tr>
										...
										<td>
											<?php $_SESSION['theatrename']=$theatre['name']; $_SESSION['theatreplace']=$theatre['place']; echo $theatre['name'].", ".$theatre['place'];?>
										</td>
										</tr>
										<tr>
											<td>
							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								?>
									...
									<tr>
										...
										<td>
											<?php $_SESSION['time']=$ttme['start_time'];echo date('h:i A',strtotime($ttme['start_time']))." ".$ttme['name'];?> Show
										</td>
									</tr>
									<tr>
										<td>
